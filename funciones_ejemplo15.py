#Funciones_ejemplo15
#Confeccionar una función que reciba el nombre de un operario, el pago por hora y la cantidad de horas trabajadas. Debe mostrar su sueldo y nombre. Hacer la llamada de la función mediante argumentos nombrados.
